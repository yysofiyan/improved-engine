...
@section('title', 'Buat NIM Calon Mahasiswa Baru')
    ...
    <div class="col-md-12 grid-margin">
        <div class="row">
            <div class="col-12 mb-4 mb-xl-0">
                <h3 class="font-weight-bold">Buat NIM  Calon Mahasiswa Baru </h3>
            </div>
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title mb-5">NIM Calon Mahasiswa Baru </h4>
                <a href="{{ url('keuangan/tambah-nim') }}" class="btn btn-primary" style="margin-bottom: 20px" id="btnImport">Buat NIM Baru</a>
