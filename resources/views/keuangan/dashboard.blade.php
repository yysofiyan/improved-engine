        ...
        if (pendaftaranChart) {
            const options = {
                ...
                xaxis: {
                    ...
                    series: [
                        {
                            name: 'Pendaftar Harian 2024',
                            data: {!! json_encode(\App\Helpers\AkademikHelpers::getPendaftarHarian2024()) !!}
                        },
                        {
                            name: 'Pendaftar Harian 2025',
                            data: {!! json_encode(\App\Helpers\AkademikHelpers::getPendaftarHarian2025()) !!}
                        }
                    ],
                    labels: {
                        style: {
