...
@section('title', 'Calon Mahasiswa Baru Rekomendasi')
    ...
    <div class="col-md-12 grid-margin">
        <div class="row">
            <div class="col-12 mb-4 mb-xl-0">
                <h3 class="font-weight-bold"> Calon Mahasiswa Baru Rekomendasi {{ \App\Helpers\AkademikHelpers::getFakultasNama(session('kodeprodi')) }} </h3>
            </div>
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title mb-5">Data Calon Mahasiswa Baru Rekomendasi {{ \App\Helpers\AkademikHelpers::getFakultasNama(session('kodeprodi')) }} </h4>
