      ...
      <div class="col-md-12 grid-margin stretch-card">
        <div class="card position-relative">
          <div class="card-body">
            ...
            <div class="row mb-5">
              <div class="col-sm-3">
                  <button class="btn btn-primary" onclick="openFormBiodata()"> <i class="fa-solid fa-users fa-fw mr-2"></i>Langkah 1 Formulir</button>
              </div>
              <div class="col-sm-3">
                  <button class="btn btn-success" onclick="openFormPersyaratan()"> <i class="fa-solid fa-folder-plus fa-fw mr-2"></i> Langkah 2 Persyaratan</button>
              </div>
  
              <div class="col-sm-3">
                <button class="btn btn-warning" onclick="openFormUjian()"> <i class="fa-solid fa-list fa-fw mr-2"></i> Langkah 3 Ujian</button>
            </div>
  
            <div class="col-sm-3">
              <button class="btn btn-info" onclick="openFormHasil()"> <i class="fa-solid fa-ticket-alt fa-fw mr-2"></i> Langkah 4 Hasil Kelulusan</button>
          </div>
            ...
            <div class="row">
              <div class="col-lg-12">
                ...
                <div id="soal" class="formName" style="display:none">
                  <form action="{{ url('operator/import-member/') }}" method="post"
                  id="formImport">
                  @csrf
                  <h2>
                      PIN PENDAFTARAN : {!! session('pin')!!}
                  ...
                  <div class="row">
                      ...
                      <div class="form-group col-lg-6 mx-auto @error('asal_sekolah') has-danger @enderror">
                          <label class="col-sm-12 "><strong>Silahkan Klik Tombol Dibawah untuk memulai Ujian </strong></label>
                          <a href="{{url('soal')}}" class="btn btn-info mr-2"> <i class="fa-solid fa-tasks fa-fw mr-2"></i> Mulai Ujian</a>
                      </div>
                      @else
                      <div class="form-group col-lg-6 mx-auto @error('asal_sekolah') has-danger @enderror">
                          <label class="col-sm-12 btn btn-success mr-2 "><strong>Hasil Ujian Sudah Ada Silahkan Klik Pengumuman Kelulusan </strong></label>
                ...
                <div id="hasil" class="formName" style="display:none">
                  ...
                  <div class="row">
                    <div class="form-group col-lg-12 mx-auto @error('asal_sekolah') has-danger @enderror">
                        <label class="col-sm-12 "><strong>Surat Pengumuman Kelulusan</strong></label>
                        <a target='_blank' href="{{ url('operator/lihatpdf/'.$mhs->nomor_pendaftaran)}}" class="btn btn-info mr-2"> <i class="fa-solid fa-receipt fa-fw mr-2"></i> Download Surat Pengumuman Kelulusan</a>

                        <a href="{{ url('operator/selesai-rekom/') }}" class="btn btn-danger mr-2"> <i class="fa-solid fa-close fa-fw mr-2"></i> Selesai </a>
                    </div>
