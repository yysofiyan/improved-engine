...
<img src="{{$headers['HEADER_LOGO']}}" style="margin-top:-40px;margin-left:-5px;" width="700px" height="150px">    
<h2 style="margin-bottom: -5px">PENGUMUMAN KELULUSAN MAHASISWA BARU</h2>
...
<table style="font-size:14px">
    <tbody>
        ...
        <tr>
            ...
            <td>:</td>
            <td>{{$formulir->nama_mahasiswa}}</td>
        </tr>
        <tr>
            <td><strong>Nomor Pendaftaran/PIN</strong></td>
            <td>:</td>
            <td>{{$formulir->nomor_pendaftaran.' / '.$formulir->pin}}</td>
        </tr>
        <tr>
...
<table width="100%" cellspacing="0px" cellpadding="0px" style="margin-top:20px">
    <tr>
        <td style="text-align:center;vertical-align:top"><img src="{{$headers['TANDATANGAN']}}" width="800px" height="175px">  </td>
    </tr>
</table>
<br/>
<br/>
...
<pagebreak></pagebreak>  
<h2 style="margin-bottom: 0px">RINCIAN PEMBAYARAN BIAYA KULIAH REGISTRASI PERTAMA  
</h2>
<p style="font-size:14px;text-align:center;font-weight: bold;margin-top:-5px;">============================================================================</p>
...
<table style="font-size:14px;width:100%">
    ...
    <img src="{{ \App\Helpers\AkademikHelpers::public_path("images/uang_sumbangan.png") }}" width="700px" height="150px">  
...
<table style="font-size:14px;width:100%">
    ...
    <img src="{{\App\Helpers\AkademikHelpers::public_path("images/uang_praktik.png")}}" width="700px" height="200px">  
