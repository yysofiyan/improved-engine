...
{{-- <body style="line-height:1.5;">
    ...
    <div class="header-surat">
        ...
        <p style="font-size:20px;text-align:center;font-weight:bold;margin-top:20px;line-height:1;">PENGUMUMAN KELULUSAN MAHASISWA BARU</p>
    ...
    <div class="konten-utama" style="text-align: justify; width: 600px; margin: 0 auto;">
        <p><strong>INFORMASI PMB 2025/2026:</strong></p>
        <ol style="text-align: justify">
            <li>Paling lambat satu minggu setelah hari ini, Saudara wajib melakukan registrasi dengan membayar lunas keuangan sesuai ketentuan.</li>
            <li>Seluruh pembayaran keuangan dilakukan pada <strong>Bank Jabar dan Banten (BJB) Cabang Sumedang</strong> dengan nomor rekening <strong>011.001.0011941</strong>.</li>
            <li>Bukti pembayaran harus diupload pada laman <a href="https://online.ypsa-sumedang.or.id/">https://online.ypsa-sumedang.or.id/</a> atau diserahkan ke Sekretariat YPSA.</li>
            ...
            <li>Informasi PKKMB akan diinformasikan melalui laman <a href="https://unsap.ac.id">https://unsap.ac.id</a>.</li>
        </ol>
    </div>

    {{-- <div class="footer-s1">
        <img src="{{ public_path('images/ttd_s1.png') }}" style="width:200px;height:auto;">
    </div> --}}

    <div class="footer-surat">
        <p>Sumedang, {{ date('d F Y') }}</p>
        <img src="{{ public_path('images/tanda_tangan2025.png') }}" style="max-width: 700px; height: auto;">
    </div>
