...
<div class="row">
    <div class="col-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title mb-5">Masukan Kode PIN Pendaftaran</h4>
                <div class="card-description">
                    <p>Petunjuk :</p>
                    <ol class="list">
                        <li>Silahkan Masukan Kode PIN Pendaftaran
                        </li>
                    </ol>
                </div>
                <form action="{{ url('operator/get-pin/') }}" method="post" 
                    id="formImport">
                    @csrf
