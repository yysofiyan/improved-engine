                ...
                <div id="hasil" class="formName" style="display:none">
                  ...
                  <div class="row">
                    <div class="form-group col-lg-6 mx-auto @error('asal_sekolah') has-danger @enderror">
                        ...
                        <a target="_blank" href="{{ url('admin/lihatpdf/'.$mhs->nomor_pendaftaran)}}" class="btn btn-info mr-2"> <i class="fa-solid fa-receipt fa-fw mr-2"></i> Download Surat Pengumuman Kelulusan</a>
                    </div>
