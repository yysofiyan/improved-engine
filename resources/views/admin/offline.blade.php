...
@section('title', 'Laporan Pembayaran Offline Calon Mahasiswa Baru')
    ...
    <div class="col-md-12 grid-margin">
        <div class="row">
            <div class="col-12 mb-4 mb-xl-0">
                <h3 class="font-weight-bold">Laporan Pembayaran Offline Calon Mahasiswa Baru </h3>
            </div>
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title mb-5">Data Pembayaran Offline Calon Mahasiswa Baru </h4>
                <form id="MabaForm" name="MabaForm" action="{{url('admin/pos_offline')}}" method="POST">
                    @csrf
                <div class="row">
                ...
                <div class="row">
                    <div class="form-group col-lg-12 ml-3">
                        ...
                        <a target="_blank" href="{{ url('/admin/printofflinepdf')}}" class="btn btn-info mr-2"> <i class="fa-solid fa-print fa-fw mr-2"></i> Cetak</a>
                        <a href="{{ url('/admin/reset-offline')}}" class="btn btn-warning mr-2"> <i class="fa-solid fa-repeat fa-fw mr-2"></i> Reset</a>
                    </div>
